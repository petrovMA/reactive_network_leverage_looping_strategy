...
contract LeverageAccount is AbstractCallback, Ownable {
    ...
    function fullClosePosition(address collateralAsset, address debtAsset) external onlyOwner {
        ...
        uint256 collateral = lendingPool.supplies(address(this), collateralAsset);
    ...
    function getStatus() external view returns (uint256 collateral, uint256 debt, uint256 ltv) {
